...
func welcomeScreen(_ fyne.Window, Data interface{}) fyne.CanvasObject {
	...
	footer := container.NewHBox(
		layout.NewSpacer(),
		widget.NewHyperlink("k9fyne", parseURL("https://github.com/andrewbytecoder/k9fyne")),
		widget.NewLabel("-"),
		widget.NewHyperlink("documentation", parseURL("https://github.com/andrewbytecoder/k9fyne/docs")),
		widget.NewLabel("-"),
		widget.NewHyperlink("sponsor", parseURL("https://github.com/andrewbytecoder/k9fyne")),
		layout.NewSpacer(),
	)
