...
var tutorials = map[string]GeneratedTutorial{
	"docs/circle.md": GeneratedTutorial{
		title:   "Canvas : Circle",
		...
		code: []func() fyne.CanvasObject{
			func() fyne.CanvasObject {
				circle := canvas.NewCircle(color.NRGBA{B: 0x80, A: 0xff})
				return circle
			},
			func() fyne.CanvasObject {
				circle := canvas.NewCircle(color.NRGBA{R: 0x30, G: 0x30, B: 0x30, A: 0xb0})
				circle.StrokeColor = color.NRGBA{R: 0x80, A: 0xff}
				circle.StrokeWidth = 2
				return circle
			},
		},
	...
	"docs/gradient.md": GeneratedTutorial{
	...
	"docs/image.md": GeneratedTutorial{
		title:   "Canvas : Image",
	...
	"docs/line.md": GeneratedTutorial{
		title:   "Canvas : Line",
	...
	"docs/raster.md": GeneratedTutorial{
		title:   "Canvas : Raster",
	...
	"docs/rectangle.md": GeneratedTutorial{
		title:   "Canvas : Line",
	...
	"docs/text.md": GeneratedTutorial{
		title:   "Canvas : Text",
	...
	"docs/accordion.md": GeneratedTutorial{
	...
	"docs/activity.md": GeneratedTutorial{
	...
	"docs/button.md": GeneratedTutorial{
